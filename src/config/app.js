...
export const ROLES = {
  admin: {
    ...
    pages: ['dashboard','pos','catalog','inventory','suppliers','purchases','cash','clients','reports','users','audit','alerts','settings'],
  },
  gerente: {
    label: 'Gerente', color: 'bg-purple-100 text-purple-700',
    pages: ['dashboard','pos','catalog','inventory','suppliers','purchases','cash','clients','reports','audit','alerts'],
  },
  supervisor: {
    label: 'Supervisor', color: 'bg-amber-100 text-amber-700',
    pages: ['dashboard','pos','catalog','inventory','cash','clients','alerts'],
  },
  cajero: {
